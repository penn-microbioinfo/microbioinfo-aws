...
cellranger count --fastqs . --transcriptome /simoni-data/ref/refdata-gex-GRCh38-2020-A --id Pla_HDBR8715514 --sample Pla_HDBR8715514 --include-introns false --localcores 8 --localmem 58 --chemistry auto
